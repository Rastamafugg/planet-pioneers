...
| 2b  | **`poc_shmem`** ⏳ live-test              | Two processes share a memory region via `F$AllRAM` + `F$MapBlk` (block-number passing); see [platform/ipc.md](../platform/ipc.md). C-side built 2026-04-25 | 1 wk    | Mechanism confirmed in Tech Ref + kernel source 2026-04-24; PoC validates the pattern in C |
