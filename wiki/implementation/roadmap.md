...
| 4   | Render module / process ⏳                | [`render.c`](../../src/c/render.c) parent API + [`poc_rndc`](../../src/c/poc_rndc.c) child; 64-entry SPSC RenderCmd ring; child owns CoVDG path + both 16K screens + page-flip. Code landed 2026-04-25; awaiting EOU live-test | 1–1.5 wk | `R_OP_PALETTE` deferred (SS.PalSet codepath unconfirmed) |
